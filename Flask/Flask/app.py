...
def opencv():
    ...
    while(1):
        ...
        if pred[0]==1:
            ...
            account_sid = 'AC62f2bafe2db36ae07b31a60eca112b0f'
            auth_token = '8f245589989c8958ab6ef08cf7d99a58'
            client = Client(account_sid, auth_token)

            message = client.messages \
            .create(
             body='Forest Fire is detected, stay alert',
             from_= '+1 586 371 5300', #twilio free number
             to= '+918461974848')
            print(message.sid)
